  ...
  return (
      <div className="home_container">
        ...
        <div className="cards-container1">
          {[{
            icon: <FaHandshake className="img" />, title: "Employee Rights and Responsibilities",
            text: "know your rights and responsibilities under Evvap-Verify"
          }, {
            icon: <FaMagnifyingGlassPlus className="img" />, title: "Evaap-Verify Candidates",
            text: "Streamline your employment eligibility verification process with our new service"
          }, {
            icon: <IoManSharp className="img" />, title: "Evaap-Verify Employee",
            text: "Send us your documentation via myUploads and resolve your E-Verify case"
          }].map((card, i) => (
              <div className="maincards" key={i}>
                <div className="cards">
                  {card.icon}
        ...
        <div className="explore-section">
          <section className="explore-articles">
            ...
            <div className="tags">
              {["Engineering", "IT Services", "HR Management"].map((tag, i) => (
          ...
          <section className="explore-jobs">
            ...
            <div className="tags">
              {["Engineering", "Business Development", "Finance", "Administrative Assistant",
                ...
                "Information Technology", "Marketing", "Human Resources"].map((tag, i) => (
                  <button key={i} className="tag-btn">{tag}</button>
              ))}
        ...
        <div className="main-wrapper">
          <section className="impact-section">
            <div className="impact-box">
              <h3>Impact of Verify <span>On Evvap</span></h3>
              <div className="impact-metrics">
                <div>
                  Verify empowers EVVAAP to authenticate students and employees with unmatched accuracy, boosting trust and operational efficiency
                </div>
              </div>
            </div>
          </section>
